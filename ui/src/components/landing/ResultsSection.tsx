    ...
    <section id="results" className="py-8 px-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <p className="text-slate-600 dark:text-slate-300 text-base mt-4 leading-relaxed font-normal">
          Every registration result is rigorously certified using independent 80/20 holdout cross-validation, sub-pixel IC-LK convergence, and geodetic CE90 circular error metrics.
        </p>
      </motion.div>
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/90 p-6 md:p-8 backdrop-blur-md shadow-xl">
        <div className="flex items-center justify-between pb-6 mb-6 border-b border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">Target Accuracy Specifications</h3>
          </div>
          <span className="text-xs font-mono text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-800/80 px-3 py-1 rounded-md border border-slate-200 dark:border-slate-700">SIH 2026 PS 26166 Operational Targets</span>
        </div>
